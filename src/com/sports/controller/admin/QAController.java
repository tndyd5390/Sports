...
public class QAController {
	...
	public String QAList(HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
		...
		for (QADTO qaDTO : rList) {
			...
			String title = CmmUtil.nvl(qaDTO.getTitle()); // 제목이 14자 이상이면
															// ...붙여주기
	...
	public String QAReg(HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
	...
	public String QADetail(HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
	...
	public String QACheckboxDelete(HttpServletRequest request, HttpServletResponse response, ModelMap model)
			throws Exception {
	...
	public String QAAnswerReg(HttpServletRequest request, HttpServletResponse response, ModelMap model)
			throws Exception {
	...
	public String QAAnswerInsert(HttpSession session, HttpServletRequest request,
		...
		try {
			...
			if (!file.getOriginalFilename().equals("")) {
				...
				String FileSaveRootPath = "C:/Users/data8316-26/git/SportsApp/WebContent"; // 저장될
																							// 웹루트
				...
				// 저장 경로
				String savePath = "/upload/qa_file/" + DateUtil.getTodayYYYY() + "/" + DateUtil.getTodayMM() + "/"
						+ DateUtil.getTodayDD();
	...
	public String QAAnswerDetail(HttpServletRequest request, HttpServletResponse response, ModelMap model)
			throws Exception {
	...
	public String QAAnswerEdit(HttpServletRequest request, HttpServletResponse response, ModelMap model)
			throws Exception {
	...
	public String QAAnswerUpdate(HttpSession session, HttpServletRequest request,
			@RequestParam("qa_file") MultipartFile file, ModelMap model) throws Exception {
	...
	public @ResponseBody List<QADTO> getQAMoreView(@RequestParam(value = "cnt") String cnt,
		...
		for (QADTO qaDT : viewMore_list) { // new 붙히는 시간 계산해서 rList의 title에 new
											// 붙여주기
