...
<link rel="stylesheet" href="/html5/common/css/chy-cascadingStyleSheet.css" type="text/css">
			...
			<div id="myTabContent" class="tab-content">
				<div role="tabpanel" class="tab-pane fade active in" id="home"
					...
					<h2 class="chy-chartHeader" style="margin-top:30px;">
						<span class="chy-headerWeek" id="chy-headerWeek">2017/03/12</span>
